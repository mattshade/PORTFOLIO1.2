// Edit this file for the on-site resume page. The downloadable file is `public/MattShade.pdf` (replace manually from your ATS export).
...
export const resume = {
  name: 'Matt Shade',
  title: 'Engineering Leadership | Design Engineering',
  tagline:
  ...
  /** Download link — served from `public/MattShade.pdf`. Bump `v=` when you replace the file so prod CDNs/browsers fetch the new PDF. */
  resumePdf: '/MattShade.pdf?v=1',
  ...
  experience: [
    {
      ...
      highlights: [
        'Built custom GenAI agents that solved real newsroom problems, from on-air scheduling to complex newsgathering logistics.',
        'Launched AI-enablement programs (hands-on workshops and technical office hours) that helped teams actually adopt agentic tools into their daily work.',
        'Partnered with editorial leadership to identify, prototype, and deploy LLM-driven workflows across the news group.'
      ],
    },
    {
